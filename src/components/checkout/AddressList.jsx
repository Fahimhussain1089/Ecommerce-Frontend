    ...
    <div className='space-y-4'>
        {addresses.map((address) => (
            <div
                ...
                // }`}>
                 className={`p-4 border rounded-md cursor-pointer relative ${
                        selectedUserCheckoutAddress?.id === address.id  // ✅ Change to 'id'
                        ? "border-green-400 border-2 bg-green-100"  // Added border for better visibility
                ...
                <div className="flex gap-3 absolute top-4 right-2">
                    ...
                    // onClick={() => onEditButtonHandler(address)}>
                     onClick={(e) => {
                                e.stopPropagation(); // Prevent address selection when editing
                    ...
                    onClick={(e) => {
                                e.stopPropagation(); // Prevent address selection when deleting
