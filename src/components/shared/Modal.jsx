  ...
  return (
    <>
      <Dialog open={open} onClose={() => setOpen(false)} className="relative z-10">
        ...
        {/* <DialogBackdrop className="fixed inset-0 top-[70px] bg-gray-500/75 transition-opacity duration-500 ease-in-out data-closed:opacity-0" /> */}

        
        <div className="fixed inset-0 overflow-hidden">
{/* <div className="fixed inset-0 overflow-hidden top-[70px]"> */}
            ...
            <div className='absolute inset-0 overflow-hidden'>
                <div className='pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10'>
                    {/* <DialogPanel transition
                        ...
                        <DialogPanel
                            transition
                            className="pointer-events-auto relative w-screen max-w-[800px] transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700 pt-[70px]"
                            >
                            <div className='flex h-full flex-col overflow-y-scroll bg-white shadow-xl'>
                                ...
                                <div className='relative mt-1 flex-1 p-8'>
